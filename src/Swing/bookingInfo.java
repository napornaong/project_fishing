...
public class bookingInfo extends JFrame {
	...
	public bookingInfo() {
		...
		lblNewLabel.setFont(new Font("맑은고딕", Font.BOLD, 21));
		...
		JLabel lblNewLabel_1 = new JLabel("고객예약정보");
		lblNewLabel_1.setFont(new Font("맑은고딕", Font.PLAIN, 15));
		...
		JLabel lblNewLabel_2 = new JLabel("�����ȣ");
		...
		JLabel lblNewLabel_9 = new JLabel("�� �� ó");
