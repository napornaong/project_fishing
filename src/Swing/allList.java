...
public class allList extends JFrame {
	private static final ArrayList<ObDTO> ObDTO = null;
	JPanel cP;
	...
	public allList(ArrayList<String[]> adto){
		super("예약리스트");
	...
	public void initList(ArrayList<String[]> adto) {
		
		for(int i=0 ; i < adto.size(); i++) {
			tableModel.addRow(adto.get(i));
